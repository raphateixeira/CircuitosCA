...
::: {.callout-tip}
## Potência Instantânea
$$p(t) = \underbrace{V_{rms}I_{rms}\cos\theta\,[1+\cos(2\omega t+2\theta_i)]}_{\text{parcela “resistiva”, sempre}\geq 0} \;-\; \underbrace{V_{rms}I_{rms}\sin\theta\,\sin(2\omega t+2\theta_i)}_{\text{parcela “reativa”, oscila em torno de }0}$$
:::
...
::: {.callout-tip}
## Potência Média (Ativa)
$$P = V_{rms}I_{rms}\cos\theta = \frac{1}{2}V_mI_m\cos(\theta_v-\theta_i) \qquad [\text{W}]$$
:::

---

## Potência Média (Ativa) — Observações
...
::: {.callout-tip}
## Potência Reativa
$$Q = V_{rms}I_{rms}\sin\theta = \frac{1}{2}V_mI_m\sin(\theta_v-\theta_i) \qquad [\text{var}]$$
:::
...
::: {.callout-tip}
## Potência Complexa
$$\mathbf{S} = \frac{1}{2}\mathbf{V}\mathbf{I}^{*} = \mathbf{V}_{rms}\mathbf{I}_{rms}^{*} = P+jQ$$
:::
...
## Correção do Fator de Potência — Capacitância

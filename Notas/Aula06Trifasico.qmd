...
::: {.callout-tip}
## Relação Fase-Linha (Y)
$$\mathbf{V}_{ab} = \mathbf{V}_{an}-\mathbf{V}_{bn} = \sqrt{3}\,\mathbf{V}_{an}\angle 30°$$
:::
...
::: {.callout-tip}
## Potência em Grandezas de Linha
$$P = \sqrt{3}\,V_L I_L\cos\theta \qquad Q=\sqrt{3}\,V_L I_L\sin\theta \qquad S=\sqrt{3}\,V_L I_L$$
:::
...
## Potência em Grandezas de Linha — Observação
...
::: {.callout-tip}
## Fórmulas dos Dois Wattímetros
$$P = W_1+W_2 = \sqrt{3}\,V_LI_L\cos\theta \qquad\qquad Q = \sqrt{3}\,(W_2-W_1) = \sqrt{3}\,V_LI_L\sin\theta$$
:::

---

## Dois Wattímetros — Fator de Potência

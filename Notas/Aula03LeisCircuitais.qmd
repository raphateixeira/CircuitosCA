...
## Lei de Kirchhoff das Tensões — Forma Fasorial
...
## Lei de Kirchhoff das Correntes — Forma Fasorial
...
::: {.callout-tip}
## Impedância Equivalente — Série
$$\mathbf{Z}_{eq} = \frac{\mathbf{V}}{\mathbf{I}} = \mathbf{Z}_1+\mathbf{Z}_2+\cdots+\mathbf{Z}_N = \sum_{n=1}^{N}\mathbf{Z}_n$$
:::
...
::: {.callout-tip}
## Divisor de Tensão
$$\mathbf{V}_1 = \frac{\mathbf{Z}_1}{\mathbf{Z}_1+\mathbf{Z}_2}\,\mathbf{V}, \qquad \mathbf{V}_2 = \frac{\mathbf{Z}_2}{\mathbf{Z}_1+\mathbf{Z}_2}\,\mathbf{V}$$
:::

---

## Divisor de Tensão — Exemplo Numérico
...
::: {.callout-tip}
## Impedância Equivalente — Paralelo
$$\frac{1}{\mathbf{Z}_{eq}} = \frac{\mathbf{I}}{\mathbf{V}} = \frac{1}{\mathbf{Z}_1}+\frac{1}{\mathbf{Z}_2}+\cdots+\frac{1}{\mathbf{Z}_N} = \sum_{n=1}^{N}\frac{1}{\mathbf{Z}_n}$$
:::
...
## Divisor de Corrente — Exemplo Numérico
...
Dois elementos com $\mathbf{Z}_1 = 4+j3\ \Omega$ e $\mathbf{Z}_2 = 2-j2\ \Omega$ estão em paralelo. Calcule $\mathbf{Z}_{eq}$ usando admitâncias.
